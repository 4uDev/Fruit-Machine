...
public class SlotMachineGUI {
	...
	private int credits = 100, boughtCredits = 100, bet = 10, matchThree, matchTwo, win, lost;
	private double payout = 25.0, creditBuyout = 15.0, funds;
	...
	private void createForm() {
		...
		frmFrame.setTitle("Fruit Machine - By Roxla");
	...
	private void addFields() {
		...
		lblStatus.setText("Welcome to the Fruit Machine!!");
	...
	class SpinHandler implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			if (funds < creditBuyout && credits < bet) {
				lblStatus.setText("A game brought to you by Yannos. Relax Enjoy Discover");
